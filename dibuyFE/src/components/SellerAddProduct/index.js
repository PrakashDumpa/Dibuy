...
const availableCategories = [
  { displayText: "Vegetables", id: "Vegetables" },
  { displayText: "Fruits", id: "Fruits" },
  { displayText: "Electronics", id: "Electronics" },
  { displayText: "Pulses", id: "Pulses" },
  { displayText: "Others", id: "Others" },
  { displayText: "Grains", id: "Grains" },
];
const SellerAddProduct = () => {
  ...
  const renderSellerAddProductView = () => (
    <div className="addProductCon mt-3 p-5 d-flex justify-content-center">
      <form
        className="card p-5 d-flex flex-row col-7 formConSeller"
        onSubmit={onSubmit}
      >
        <div className="d-flex flex-column col-6">
          ...
          >
            {availableCategories.map((obj) => (
              <MenuItem value={obj.id} key={uuidv4()}>
                {obj.displayText}
              </MenuItem>
            ))}
          </Select>
  ...
  const renderAddProductSuccessView = () => (
    <div className="d-flex flex-column mt-3">
      <div className=" d-flex flex-column justify-items-center align-items-center">
        <div className="">
          <img
            src="https://img.freepik.com/free-vector/webrooming-abstract-concept-illustration_335657-3898.jpg?w=740&t=st=1675242821~exp=1675243421~hmac=ed561424b3c0b56dfdcfaae889ac310a23523112018a9581b4d02eafd6503f91"
            alt=""
            className="productSuccssAdd"
          />
        </div>
    ...
    <div className="d-flex justify-content-center">
      <div className="p-3 manageSellerCon d-flex flex-column">
        <div className="w-100">
          ...
          {submited
            ? renderAddProductSuccessView()
            : renderSellerAddProductView()}
        </div>
      </div>
    </div>
  );
