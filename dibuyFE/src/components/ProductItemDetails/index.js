...
class ProductItemDetails extends Component {
  ...
  renderSimilarProducts = () => (
    <div className="simalarProductsCon p-5">
      ...
      {this.state.similarProducts[0].price === undefined ? (
        <div className="mt-3">
        ...
        <div className="d-flex flex-wrap justify-content-around">
          {this.state.similarProducts.map((obj, ind) => (
            <TechCard
              eachCard={{ ...obj, index: ind }}
              key={uuidv4()}
              borderColors={borderColors}
              updateStateForSimilarProdClick={
                this.updateStateForSimilarProdClick
              }
            />
          ))}
        </div>
  ...
  renderSuccessView = () => {
    ...
    const { title, description, imageUrl, price, quality, quantity } =
      productDet;
    return (
      <>
          ...
          <div className="itemParentCon">
            <div className=" d-flex ">
              ...
              <div className="d-flex flex-column p-2 justify-content-around">
                ...
                <div className="d-flex">
                  <button type="button" className="btn btn-warning d-flex p-1">
                ...
                <li className="d-none d-md-block col-md-2">
                  <div className="rounded-pill pill d-flex quantity justify-content-around align-items-center">
                    ...
                    >
                      <AiOutlineMinus className="p-0 m-0" />
                    </button>
                    ...
                    <button
                      ...
                      onClick={() => this.setQuantity("+")}
                    >
                      <AiOutlinePlus className="p-0 m-0" />
                    </button>
                  </div>
                </li>
                <button
