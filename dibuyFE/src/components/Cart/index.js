  ...
  const getCartProducts = async () => {
    try {
      ...
      if (productsFet.ok) {
        ...
        const finalCart = cart.map((obj) => ({
          ...obj,
          cartQuantity: quantities[obj._id],
        }));
        let total = 0;
        finalCart.forEach((obj) => {
                      ...
                      <ul className="list-unstyled d-flex">
                        ...
                        <li className="d-none d-md-block col-md-2">
                          <div className="rounded-pill pill d-flex quantity justify-content-around align-items-center">
                            <p className="p-0 m-0 text-dark h6">
                              {obj.cartQuantity}
                            </p>
                          </div>
                        </li>
                        <li className="col-md-1 d-none d-md-block">
                          {obj.price * obj.cartQuantity}
                        </li>
                        <li className="col-1">
                          <button
                            type="button"
                            className="btn p-0 m-0"
                            onClick={() => removeProduct(obj._id)}
                          >
                            <AiFillCloseCircle className="h4 text-danger" />
                          </button>
                        </li>
                      </ul>
                      <div className="">
                    ...
                    <div className="">
                      <div className="card text-center">
                        <div className="card-header">
                          Order Total:<small className="ml-4">Rs.</small>
                          <span className="h4">{cartValue}</span>
                        </div>
                ...
                {orderSuccess && (
                  <div className="summaryConB col-md-3 col-12 ">
                    <div className="summaryCon text-center">
                      ...
                      <div className="">
                        <img
                          src="https://img.freepik.com/free-vector/successful-purchase-concept-illustration_114360-1003.jpg?w=740&t=st=1674810639~exp=1674811239~hmac=ed5176f298be493c2664f80fab02787455f849c6b9e8b71c67a00f73baffbdda"
                          className="w-100"
                          alt="sucessImage"
                        />
                      </div>
    ...
    <>
      ...
      <div className="d-flex flex-column vh-100 justify-content-center align-items-center">
        ...
        <p className="small text-secondary">
          Explore our products section and add Fun.
        </p>
