        ...
        <div className="mb-5 align-self-center d-flex mt-5 rounded secImage">
          <div className="col-6 d-flex justify-content-center align-items-center">
            <img
              className="h-75"
              alt="security"
              src="https://img.freepik.com/premium-vector/personal-data-security-cyber-data-security-online-concept-illustration-internet-security-information-privacy-flat-vector-illustration-banner-protection_128772-937.jpg?w=740"
            />
          </div>
          <div className="col-6 d-flex justify-content-center flex-column align-items-center">
            ...
            <h1 className="colorSuccess h4 mt-3">
              {showMsg !== "" && showMsg}
            </h1>
          </div>
        </div>
