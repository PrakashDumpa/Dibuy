...
const UserAccount = () => {
  ...
  const [accountCardApiStatus, setAccountCardApiStatus] = useState(
  ...
  const renderDialog = () => (
    <Dialog open={qr} onClose={handleClose}>
    ...
    <div className=" h-100 d-flex flex-column justify-content-center align-self-center">
      <div className="shadow userCon rounded w-100 p-3 d-flex flex-column">
        ...
        <div className="col-6 align-self-center p-3">
          <div className="text-secondary d-flex flex-column m-3 w-100">
            ...
            <div className="w-100 ">
              <TextField
                ...
                onChange={(event) => setPassowordOne(event.target.value)}
                value={passwordOne}
          ...
          <div className="text-secondary d-flex flex-column m-3">
            ...
            <div className="">
              <TextField
                ...
                variant="standard"
                inputProps={{ style: { color: "white" } }}
                onChange={(event) => setPassowordTwo(event.target.value)}
                value={passwordTwo}
                type="password"
              />
            </div>
          ...
          {success && (
            <p className="text-success h5">Password Successfully Changed</p>
          )}
          {error && (
          ...
          <div className="text-right mt-4">
            <Button
              variant="contained"
              color="info"
              onClick={() => onClickChangePasswordAndProfilePic("password")}
            >
              Save Changes
            </Button>
          </div>
  ...
  const renderAccountCardSuccessView = () => (
    <div className="d-flex mainAccountCon text-white p-4 w-100 h-100">
      <div className=" h-100 d-flex flex-column align-items-center justify-content-center col-3">
        <div className="avatarCon">
          ...
          <span className="uploadEle" onClick={onClickUpload}>
            <input
              type="file"
              className="d-none"
              ref={InputImageEleRef}
              onChange={uploadImage}
              accept=".jpeg,.png,.jpg"
            />
            <BootstrapTooltip
              TransitionComponent={Zoom}
              title="Please upload image less than 100KB and Do refresh once the upload gets completed to view changes"
            >
        ...
        <h1 className="h5 mt-3 text-primary setqr" onClick={handleClickOpen}>
          Your QR
        </h1>
      </div>
      <div className="d-flex flex-row text-warning justify-content-around col-9">
        <div className="d-flex flex-column justify-content-around col-8 text-truncate">
          <div className="d-flex">
            ...
            <div className="">
              <p className="text-secondary" id="username">
                Username
              </p>
        ...
        <div className="align-self-center d-flex flex-column justify-content-around h-100 col-4">
          ...
          <div className="">
            <img
              src="https://img.freepik.com/premium-photo/top-view-lock-with-username-password-information_23-2148578101.jpg?w=740"
              alt="password"
              className="passwordImage rounded shadow-lg"
            />
            <div className="">
              <p className="text-secondary text-right m-0 p-0 mt-2">
                Forgot Password ?
              </p>
              <p
                className="text-info text-right small resetPassword"
